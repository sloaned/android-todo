...
INSERT INTO task(due_date, details, title, location, latitude, longitude, timezone, user_id) VALUES ('1458239800000', 'details, details, details...', 'First test title', 'Inner Mongolia', 0, 0, 'America/Phoenix', 1);
INSERT INTO task(due_date, details, title, location, latitude, longitude, timezone, user_id) VALUES ('1478333300000', 'details are scarce', 'New test title', 'the alley', 0, 0, 'America/Phoenix', 1);
INSERT INTO task(due_date, details, title, location, latitude, longitude, timezone, user_id) VALUES ('1457332200000', 'the devil is in the details', 'Another test title', '3 Exeter Drive', 0, 0, 'America/Phoenix', 2);
